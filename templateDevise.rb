...
if yes? "Do you want to rename devise model, default name: User?"
  deviseModel = ask("Please specify devise model name").underscore
end
if yes? "Do you want to add devise Admin model?"
  devise_admin_flag = true
end
...
generate "devise Admin" if devise_admin_flag
